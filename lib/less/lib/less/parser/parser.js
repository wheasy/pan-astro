    ...
    return {
        ...
        parsers: parsers = {
            ...
            mixin: {
                ...
                call: function () {
                    ...
                    while (true) {
                        ...
                        //edit by wanhu 增加 $ 符号支持
                        e = parserInput.$re(/^[#._$](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/);
                        if (!e) {
                            break;
                        }
                ...
                definition: function () {
                    ...
                    if ((parserInput.currentChar() !== '.' 
                            ...
                            && parserInput.currentChar() !== '$'
                            && parserInput.currentChar() !== '_') ||
                        parserInput.peek(/^[^{]*\}/)) {
                        return;
                    }
                    parserInput.save();
                    //edit by wanhu 增加 $ 符号支持
                    //edit by wanhu 增加 _ 符号支持
                    match = parserInput.$re(/^([#._$](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/);
                    if (match) {
                        name = match[1];
            ...
            element: function () {
                ...
                //edit by wanhu 增加 $,_ 符号支持
                    parserInput.$re(/^(?:[.#_$]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) ||
                    parserInput.$char('*') || parserInput.$char('&') || this.attribute() ||
                //edit by wanhu 增加 $,_ 符号支持
                    parserInput.$re(/^\([^&()@]+\)/) ||  parserInput.$re(/^[\.#_$:](?=@)/) ||
